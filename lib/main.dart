...
import 'screens/dashboard/fragment/dashboard_fragment.dart';
...
List<ServicesByCat>? cachedServicesByCategory;
BannerAdsModel? cachedBannerAds;
List<ProductCategory>? cachedProductCategories;
...
void main() async {
  ...
  if (appStore.isLoggedIn) {
    await appStore.setVerifyOTP(getBoolAsync(VERIFY_OTP));
