...
import 'package:booking_system_flutter/model/category_with_products.dart';
import 'package:booking_system_flutter/model/category_with_services.dart';
...
class DashboardResponse {
  ...
  List<CategoryWithProducts>? products_by_category;
  List<CategoryWithServices>? service_by_category;
  List<ProductData>? featured_product;
  ...
  factory DashboardResponse.fromJson(Map<String, dynamic> json) {
    final res = DashboardResponse(
      featured_product:
          json['featured_product'] != null && (json['featured_product'] is List)
              ? (json['featured_product'] as List)
                  .map((e) => ProductData.fromJson(e))
                  .toList()
              : null,
      products_by_category: json['products_by_category'] != null &&
              json['products_by_category'] is List
          ? (json['products_by_category'] as List)
              .map((e) => CategoryWithProducts.fromJson(e))
              .toList()
          : null,
      service_by_category: json['service_by_category'] != null &&
              json['service_by_category'] is List
          ? (json['service_by_category'] as List)
              .map((e) => CategoryWithServices.fromJson(e))
              .toList()
          : null,
    ...
    log("Services in dashboard response: ${res.service?.length}");
    return res;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.featured_product != null) {
      data['featured_product'] =
          this.featured_product!.map((e) => e.toJson()).toList();
    }
    if (this.products_by_category != null) {
      data['products_by_category'] =
          this.products_by_category!.map((e) => e.toJson()).toList();
    }
    if (this.service_by_category != null) {
      data['service_by_category'] =
          this.service_by_category!.map((e) => e.toJson()).toList();
    }
    ...
    if (this.upcomingData != null) {
      data['upcomming_booking'] =
          this.upcomingData!.map((v) => v.toJson()).toList();
    }
    ...
    if (this.languageOption != null) {
      data['language_option'] =
          this.languageOption!.map((v) => v.toJson()).toList();
    }
