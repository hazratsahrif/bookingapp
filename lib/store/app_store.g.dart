...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$isFavoriteAtom =
      Atom(name: '_AppStore.isFavorite', context: context);
  ...
  late final _$currentAddressAtom =
      Atom(name: '_AppStore.currentAddress', context: context);
  ...
  late final _$isEnableUserWalletAtom =
      Atom(name: '_AppStore.isEnableUserWallet', context: context);
  ...
  late final _$verifyOTPAtom =
      Atom(name: '_AppStore.verifyOTP', context: context);

  @override
  bool get verifyOTP {
    _$verifyOTPAtom.reportRead();
    return super.verifyOTP;
  }

  @override
  set verifyOTP(bool value) {
    _$verifyOTPAtom.reportWrite(value, super.verifyOTP, () {
      super.verifyOTP = value;
    });
  }

  late final _$setVerifyOTPAsyncAction =
      AsyncAction('_AppStore.setVerifyOTP', context: context);

  @override
  Future<void> setVerifyOTP(bool val, {bool isInitializing = false}) {
    return _$setVerifyOTPAsyncAction
        .run(() => super.setVerifyOTP(val, isInitializing: isInitializing));
  }
  ...
  Future<void> set24HourFormat(bool val, {bool isInitializing = false}) {
    return _$set24HourFormatAsyncAction
        .run(() => super.set24HourFormat(val, isInitializing: isInitializing));
  }
  ...
  late final _$setEnableUserWalletAsyncAction =
      AsyncAction('_AppStore.setEnableUserWallet', context: context);

  @override
  Future<void> setEnableUserWallet(bool val, {bool isInitializing = false}) {
    return _$setEnableUserWalletAsyncAction.run(
        () => super.setEnableUserWallet(val, isInitializing: isInitializing));
  }
  ...
  late final _$setBookingSelectedStatusAsyncAction =
      AsyncAction('_AppStore.setBookingSelectedStatus', context: context);

  @override
  Future<void> setBookingSelectedStatus(BookingStatusResponse val) {
    return _$setBookingSelectedStatusAsyncAction
        .run(() => super.setBookingSelectedStatus(val));
  }
  ...
  late final _$setCurrentAddressAsyncAction =
      AsyncAction('_AppStore.setCurrentAddress', context: context);

  @override
  Future<void> setCurrentAddress(String val, {bool isInitializing = false}) {
    return _$setCurrentAddressAsyncAction.run(
        () => super.setCurrentAddress(val, isInitializing: isInitializing));
  }
  ...
  Future<void> setLatitude(double val, {bool isInitializing = false}) {
    return _$setLatitudeAsyncAction
        .run(() => super.setLatitude(val, isInitializing: isInitializing));
  }
  ...
  Future<void> setLongitude(double val, {bool isInitializing = false}) {
    return _$setLongitudeAsyncAction
        .run(() => super.setLongitude(val, isInitializing: isInitializing));
  }
  ...
  Future<void> setCurrentLocation(bool val, {bool isInitializing = false}) {
    return _$setCurrentLocationAsyncAction.run(
        () => super.setCurrentLocation(val, isInitializing: isInitializing));
  }
  ...
  void setFavorite(bool val) {
    final _$actionInfo =
        _$_AppStoreActionController.startAction(name: '_AppStore.setFavorite');
    try {
