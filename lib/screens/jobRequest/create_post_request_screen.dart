  ...
  Future<void> init() async {
    ...
    await getMyServiceList().then((value) {
      ...
      if (value.userServices != null) {
        ...
        selectedServiceList = myServiceList;
      }
    }).catchError((e) {
      appStore.setLoading(false);
      toast(e.toString());
                              ...
                              children: [
                                ...
                                AppTextField(
                                  ...
                                  validator: (s) {
                                    ...
                                    if (s.toInt() <= 0)
                                      return "locale.priceAmountValidationMessage";
                                    return null;
                                  },
                                )
                              ],
                            ...
                            onTap: () {
                              ...
                              if (formKey.currentState!.validate()) {
                                ...
                                if (selectedServiceList.isNotEmpty) {
                                  ...
                                  toast(language
                                      .createPostJobWithoutSelectService);
                                }
                              }
                            },
                          ),
