          ...
          if (widget.bookings.bookingDetail!.paymentStatus == null) {
            ...
            totalAmount = (calculateTotalAmount(
                      ...
                      serviceDiscountPercent:
                          widget.bookings.bookingDetail!.discount,
                      taxes: widget.bookings.bookingDetail!.taxes,
                      extraCharges: widget.bookings.bookingDetail!.extraCharges,
                    ) -
    ...
    if (currentPaymentMethod!.type == PAYMENT_METHOD_COD) {
      ...
      if (currentPaymentMethod!.isTest == 1) {
        ...
        await stripeServices.init(
          stripePaymentPublishKey:
              currentPaymentMethod!.testValue!.stripePublickey.validate(),
          data: widget.bookings,
          totalAmount: totalAmount,
          stripeURL: currentPaymentMethod!.testValue!.stripeUrl.validate(),
          stripePaymentKey:
              currentPaymentMethod!.testValue!.stripeKey.validate(),
          isTest: true,
        );
        ...
        await stripeServices.init(
          stripePaymentPublishKey:
              currentPaymentMethod!.liveValue!.stripePublickey.validate(),
          data: widget.bookings,
          totalAmount: totalAmount,
          stripeURL: currentPaymentMethod!.liveValue!.stripeUrl.validate(),
          stripePaymentKey:
              currentPaymentMethod!.liveValue!.stripeKey.validate(),
          isTest: false,
        );
        await 1.seconds.delay;
        stripeServices.stripePay();
      ...
      if (currentPaymentMethod!.isTest == 1) {
        ...
        RazorPayServices.init(
            razorKey: currentPaymentMethod!.testValue!.razorKey!,
            data: widget.bookings,
            totalamount: totalAmount);
        ...
        appStore.setLoading(true);
        RazorPayServices.init(
            razorKey: currentPaymentMethod!.liveValue!.razorKey!,
            data: widget.bookings,
            totalamount: totalAmount);
        await 1.seconds.delay;
        appStore.setLoading(false);
      ...
      if (currentPaymentMethod!.isTest == 1) {
        ...
        FlutterWaveServices().payWithFlutterWave(
          ...
          flutterWavePublicKey:
              currentPaymentMethod!.testValue!.flutterwavePublic.validate(),
          flutterWaveSecretKey:
              currentPaymentMethod!.testValue!.flutterwaveSecret.validate(),
          isTestMode: true,
        );
      } else {
        appStore.setLoading(true);
        ...
        FlutterWaveServices().payWithFlutterWave(
          ...
          totalAmount: totalAmount,
          flutterWavePublicKey:
              currentPaymentMethod!.liveValue!.flutterwavePublic.validate(),
          flutterWaveSecretKey:
              currentPaymentMethod!.liveValue!.flutterwaveSecret.validate(),
          isTestMode: false,
        );
      }
      ...
      if (currentPaymentMethod!.isTest == 1) {
        CinetPayServices cinetPayServices = CinetPayServices(
          cinetPayApiKey:
              currentPaymentMethod!.testValue!.cinetPublicKey.validate(),
          totalAmount: totalAmount,
          bookDetailData: widget.bookings,
        ...
        CinetPayServices cinetPayServices = CinetPayServices(
          cinetPayApiKey:
              currentPaymentMethod!.liveValue!.cinetPublicKey.validate(),
          totalAmount: totalAmount,
          bookDetailData: widget.bookings,
                          ...
                          if (currentPaymentMethod!.type ==
                            ...
                            if (walletBalance >= totalAmount) {
                              showConfirmDialogCustom(
                                ...
                                primaryColor: appStore.isDarkMode
                                    ? primaryColorDark
                                    : primaryColor,
