...
class _UserChatScreenState extends State<UserChatScreen>
      ...
      if (isReceiverOnline != 1) {
        ...
        NotificationService()
            .sendPushNotifications(
                appStore.userFullName, data.message.validate(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(
        "",
        backWidget: BackWidget(iconColor: context.primaryColor),
        ...
        titleWidget: Text(
          ...
          style: boldTextStyle(
              color: context.primaryColor, size: APP_BAR_TEXT_SIZE),
        ),
        actions: [
          PopupMenuButton(
            onSelected: (index) {
            ...
            icon: Icon(Icons.more_vert_sharp, color: context.primaryColor),
            itemBuilder: (context) {
