...
class _UserWalletBalanceScreenState extends State<UserWalletBalanceScreen> {
  ...
  void initState() {
    ...
    paymentList
        .removeWhere((element) => element.type == PAYMENT_METHOD_CINETPAY);
    paymentList
        .removeWhere((element) => element.type == PAYMENT_METHOD_SADAD_PAYMENT);
    paymentList.removeWhere((element) => element.type == PAYMENT_METHOD_PAYPAL);
  }

  //TODO translate pleaseChooseAnyOnePayment
    ...
    if (currentPaymentMethod!.type == PAYMENT_METHOD_STRIPE) {
      ...
      if (currentPaymentMethod!.isTest == 1) {
        flutterWavePublicKey =
            currentPaymentMethod!.testValue!.flutterwavePublic!;
        flutterWaveSecretKey =
            currentPaymentMethod!.testValue!.flutterwaveSecret!;
      } else {
        flutterWavePublicKey =
            currentPaymentMethod!.liveValue!.flutterwavePublic!;
        flutterWaveSecretKey =
            currentPaymentMethod!.liveValue!.flutterwaveSecret!;
      }
                    ...
                    child: Column(
                      children: [
                        AppTextField(
                          ...
                          textStyle:
                              primaryTextStyle(size: 20, color: Colors.white),
                          inputFormatters: [
