...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
    ...
    return Column(
      ...
      children: [
        if (bookingDetail.status == BookingStatusKeys.complete &&
            (bookingDetail.isFreeService ||
                (bookingDetail.paymentStatus == SERVICE_PAYMENT_STATUS_PAID ||
                    bookingDetail.paymentStatus == PENDING_BY_ADMIN)))
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              24.height,
      ...
      return Column(
        ...
        children: [
          ...
          Linkify(
            ...
            text: value.bookingDetail!.description.validate(),
            style: secondaryTextStyle(),
            linkStyle: secondaryTextStyle(color: blueColor),
          ),
          // ReadMoreText(
  ...
  Widget _action({required BookingDetailResponse bookingResponse}) {
    print('start ------>>>>>');
    print(bookingResponse.bookingDetail!.status);
    print((bookingResponse.bookingDetail!.paymentStatus));
    print('end -------->>>>>');
    ...
    if ((bookingResponse.service != null &&
      ...
      return AppButton(
        ...
        (bookingResponse.bookingDetail!.paymentStatus == PAYMENT_STATUS_PAID ||
            bookingResponse.bookingDetail!.paymentStatus ==
                PAYMENT_STATUS_PENDING_BY_ADMIN)) {
      return AppButton(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          language.askForVerifiedAccount,
                          style: TextStyle(
