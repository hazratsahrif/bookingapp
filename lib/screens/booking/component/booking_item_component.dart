            ...
            if (bookingData.isSlotBooking) {
              BookingServiceStep1(
                data: ServiceDetailResponse(
                    serviceDetail: (await getServiceDetails(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              if (bookingData.isPackageBooking &&
                  bookingData.bookingPackage != null)
                CachedImageWidget(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (bookingData.isHourlyService)
                          Text(language.hourly, style: secondaryTextStyle())
                        ...
                        if (bookingData.discount != null &&
                          ...
                          Row(
                            children: [
                              Text('(${bookingData.discount.validate()}%',
                                  style: boldTextStyle(
          ...
          if (bookingData.paymentStatus != null &&
              ...
              (bookingData.handyman.validate().isNotEmpty))
            Container(
