...
class MapScreen extends StatefulWidget {
  ...
  MapScreen(
      {this.latLong, this.latitude, this.returnLocationWithAddress = false});
  final bool returnLocationWithAddress;
                ...
                AppButton(
                  ...
                  onTap: () {
                    if (destinationAddressController.text.isNotEmpty &&
                        location != null) {
                      if (widget.returnLocationWithAddress) {
                        finish(
                            context,
                            LocationWithAddress(
                                location!.latitude,
...
class LocationWithAddress {
  ...
  LocationWithAddress(this.lat, this.long, this.address);
}
