...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_custom_tabs/flutter_custom_tabs.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/uni_links/uni_links.framework"
